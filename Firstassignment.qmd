...
df_long %>% filter(Year >= 1980) %>% 
  ...
  geom_line(size=0.8) +
  geom_line(aes(x=Date, y=Average.Temp), col="red", size=1.3)+
  theme_fivethirtyeight()+
  labs(title="Temperature over time",x="Year",y="Global Temperature")+
  theme(axis.title= element_text(),
        plot.title=element_text(hjust = 0.5))+
  scale_color_manual(name="Location", values=c("turquoise","orange","brown","cornflowerblue"), labels=c("Lower atmosphere","Middle atmosphere","Stratosphere","Lower Tropopause"))
